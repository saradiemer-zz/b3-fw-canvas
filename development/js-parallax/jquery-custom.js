...
(function($) {
  ...
  $.fn.Article = function() {
     ...
     function _next(e,articleIndex) {
        if(typeof articleIndex !== 'undefined'){
            _active = articleIndex;
        }
        else _active++;
      ...
      $('.explore-cta-button').click(function(e){
            var articleIndex = $(e.currentTarget).data('articleIndex');
            _next(e,articleIndex);
        });
